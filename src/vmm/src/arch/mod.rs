...
pub use aarch64::{
    ...
    layout::CMDLINE_MAX_SIZE, layout::IRQ_BASE, layout::IRQ_MAX, layout::RESERVERD_MEM_SIZE,
    layout::RESERVERD_MEM_START, layout::SYSTEM_MEM_SIZE, layout::SYSTEM_MEM_START,
